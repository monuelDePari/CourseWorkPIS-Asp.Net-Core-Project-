...
namespace CourseWorkPIS.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,StartDate,FinishDate,Frequency")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,StartDate,FinishDate,Frequency")] Course course)
        {
            if (id != course.Id)
            {
                return NotFound();
